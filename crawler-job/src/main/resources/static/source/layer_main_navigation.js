...
var aCertN = [
    {
        ...
        'e': 'Language',
        'nav': '0100',
        'category': ['0107', '0108', '0109', '0129', '0116', '0117', '0130', '0131', '0120', '0121', '0122', '0119', '0123', '0124', '0112', '0125', '0114', '0126', '0127', '0115', '0128', '0104', '0105', '0110', '0111', '0106', '0113', '0118', '0101', '0132', '0133', '0102', '0103']
    },
    {
        'c': '职称证书',
        'e': 'Administrative Level',
        'nav': '0400',
        'category': ['0401', '0402', '0403', '0408', '0404', '0405', '0406', '0407']
    },
    {
        'c': '微软证书',
        'e': 'Microsoft',
        'nav': '0500',
        'category': ['0502', '0509', '0516', '0501', '0517', '0506', '0510', '0507', '0503', '0505', '0511', '0514', '0513', '0518', '0504', '0520', '0508', '0519']
    },
    {
        'c': 'IBM证书',
        'e': 'IBM',
        'nav': '0600',
        'category': ['0601', '0602', '0603', '0604', '0605', '0606', '0607', '0608', '0609']
    },
    {'c': '思科职业证书', 'e': 'CISCO', 'nav': '0700', 'category': ['0706', '0723', '0707', '0701', '0702', '0734', '0709']},
    {
        ...
        'nav': '0200',
        'category': ['0201', '0223', '0202', '0212', '0213', '0203', '0230', '0205', '0224', '0225', '0226', '0227', '0209', '0228', '0229', '0233', '0211', '0235', '0234', '0236', '0214', '0221', '0222', '0220', '0231', '0232', '0219', '0215', '0216', '0218', '0217', '0207', '0208']
    },
    {
        'c': '财务/金融/银行/保险证书',
        'e': 'Finance/Banks/Insurance Certificate',
        'nav': '0300',
        'category': ['0305', '0304', '0303', '0302', '0309', '0310', '0319', '0301', '0308', '0321', '0322', '0323', '0324', '0325', '0326', '0306', '0312', '0316', '0315', '0317', '0318', '0327', '0320', '0328', '0329', '0330', '0307', '0313', '0314', '0311']
    },
    {
        'c': '交通/运输/物流证书',
        'e': 'Transportation & Logistics',
        'nav': '0800',
        'category': ['0801', '0809', '0810', '0811', '0812', '0813', '0814', '0815', '0816', '0817', '0808', '0807', '0802', '0805', '0804', '0806', '0803']
    },
    {
        'c': '房地产/建筑证书',
        'e': 'Real Estate & Construction',
        'nav': '0900',
        'category': ['0905', '0908', '0901', '0903', '0907', '0906', '0902', '0904']
    },
    {
        'c': '行政/人事证书',
        'e': 'Admin/Human Resources',
        'nav': '1000',
        'category': ['1005', '1009', '1008', '1007', '1006', '1002', '1004']
    },
    {
        'c': '其它证书',
        'e': 'Others',
        'nav': '9900',
        'category': ['9916', '9904', '9902', '9914', '9913', '9901', '9906', '9905', '9910', '9909', '9908', '9907', '9911', '9903', '9912', '9915', '9917', '9918', '9919', '9920', '9921', '9922', '9923', '9924']
    }
];
var aItskillN = [
    {
...
var aMajorN = [
    ...
    {'c': '文学', 'e': 'Literature', 'nav': '0700', 'category': ['0700', '3900', '1200']},
    {
        ...
        'e': 'Engineering',
        'nav': '3600',
        'category': ['3600', '3700', '0500', '0600', '1900', '2100', '2200', '2300', '2400', '2500', '2600', '2700', '2900', '2800', '3000', '3200', '4100']
    },
